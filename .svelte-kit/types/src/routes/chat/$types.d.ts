...
type LayoutRouteId = RouteId | "/chat" | "/chat/[userId]"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/chat/+layout.server.js').load>>>>>>;
