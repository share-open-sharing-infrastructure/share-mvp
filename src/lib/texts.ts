export const texts = {
  ...
  success: {
    ...
    passwordResetSent: "If this email exists, a password reset email has been sent!",
  ...
  ui: {
    ...
    trustDescription: "Du siehst diesen Gegenstand nur, weil deren Besitzer:in dir vertraut. Füge auch Du Kontakte hinzu, um liebgewonnene Dinge nur mit Vertrauten zu teilen.",
    trustLink: "Vertrauensfunktion",
    trustedPeople: "Vertraute Personen",
    trustDescriptionSocial: "Füge Menschen hinzu, denen du einen guten Umgang mit deinen Dingen",
    yourItemsLink: "deine Dinge",
    revokeTrust: "das Vertrauen entziehen",
    allRequests: "Alle Anfragen",
    noRequestsYet: "Falls du noch keine Anfragen gestellt oder bekommen hast, nutze die",
    searchLink: "Suche",
  ...
  pages: {
    ...
    search: {
      ...
      description: "Bei AllerLeih findest du allerlei Dinge aus deiner Umgebung zum leihen, teilen, mieten, ..."
    },
    logout: {
