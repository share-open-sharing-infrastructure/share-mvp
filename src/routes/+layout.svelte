...
<Footer footerType="socialmedia">
  <div class="mx-auto my-10 max-w-screen-xl text-center">
    ...
    <FooterLinkGroup class="mb-6 flex flex-wrap items-center justify-center text-gray-900 dark:text-white">
      <FooterLink classes={{ link: "mr-4 hover:underline md:mr-6" }} href="/org/about">Über</FooterLink>
      <FooterLink classes={{ link: "mr-4 hover:underline md:mr-6" }} href="/org/imprint">Impressum</FooterLink>
      <FooterLink classes={{ link: "mr-4 hover:underline md:mr-6" }} href="/org/contact">Kontakt</FooterLink>
    </FooterLinkGroup>
