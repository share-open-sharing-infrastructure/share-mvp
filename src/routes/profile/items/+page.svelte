...
<section class="bg-white dark:bg-gray-900 min-h-screen">
	<div class="max-w-7xl mx-auto px-4 pt-6">
		...
		<h1 class="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white mt-20 mb-6">
			Du verleihst
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
			{#if data?.user?.expand?.items_via_owner?.length}
				...
				/>
			{:else}
				<div class="flex flex-col items-center text-center text-gray-500 col-span-full py-12">
