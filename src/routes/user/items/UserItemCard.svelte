...
<button
	...
	class="items-center border border-tinte-200 rounded-lg shadow flex sm:flex-row overflow-hidden w-full text-left cursor-pointer hover:bg-gray-50 transition-colors"
>
	<img
